  ...
  return (
    ...
    >
      {serviceData.map((items, i) => {
        return (
          <SwiperSlide key={i}>
            <div className='xl:h-[300px] md:h-[320px] rounded-lg px-6 py-8 flex sm:flex-col gap-x-6 sm:gap-x-0 group cursor-pointer bg-zinc-900 hover:bg-[#232224] transition-all duration-300'>
              {/* icon */}
